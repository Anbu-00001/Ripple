...
> 3. **3-minute demo video** → [**▶ Watch the demo (3 min)**](https://youtu.be/zG4Gs0Y3a0Y) — cold-opens on the red pipeline, then shows the live `max_hops:4 → compile_error` proof that Orbit's own query **cannot** do this.
